...
from codes.table_engine.split.table_text_split import build_page_entries, split_structured_table
from codes.table_engine.split.structure_split import apply_structure_split, apply_sibling_compound_header_repair
...
show_stage("build_page_entries", entries)

steps = [
    ("structure_split", lambda e: apply_structure_split(e)),
